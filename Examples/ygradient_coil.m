...
%% Run the algorithm
    ...
    ...'coil_mesh_file','cylinder_radius500mm_length1500mm.stl', ... % default parameters
    'coil_mesh_file','test.stl', ... % new stl prototype
    'target_field_definition_file','undersampled_target_field_1_24.mat', ...
    ...
    'sf_source_file','none', ...
    'min_loop_signifcance',0.1,... % min required loop contriubtion to target in percent
